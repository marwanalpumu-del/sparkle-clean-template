...
* **Direct Booking:** Integrated WhatsApp API for instant lead generation.
...
/HTML
  ...
  ├── assets/
      ...
      ├── js/           # main.js (Calculator & Theme logic)
      └── images/       # Optimized visual assets
/Documentation       # Detailed setup and customization guide
🛠️ Quick Setup
​1. Configure WhatsApp
​Open assets/js/main.js and update your business number:
const whatsappNumber = "966500000000"; // Country code + number
2. Adjust Pricing
​Edit the pricePerMeter variable in main.js to set your service rates.
​3. Change Brand Colors
​Modify the :root variables in assets/css/style.css to match your brand identity.
...
​Framework: Pure HTML5/CSS3/JavaScript (No heavy dependencies)
​📧 Support
